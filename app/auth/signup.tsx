...
import { SuccessResponseSignUpTeacher, ErrorResponseSignUpTeacher } from "../../components/services/auth-services";
...
export default function SignUp() {
  ...
  const signUpRequest = () => {
    console.log(state);
    if (state.username == "") {
      ToastAndroid.show("Please provide username. Can't be empty", ToastAndroid.SHORT);
    } else if (state.password == "") {
      ToastAndroid.show("Please provide password. Can't be empty", ToastAndroid.SHORT);
    } else {
